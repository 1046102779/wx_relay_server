...
// 获取公众号平台基本信息
func (t *WxRelayServer) GetOfficialAccountPlatformInfo() (oap *OfficialAccountPlatform, err error) {
...
// 存储托管公众号的token相关信息
func (t *WxRelayServer) StoreOfficialAccountInfo(oa *OfficialAccount) (err error) {
...
// 获取公众号token信息
func (t *WxRelayServer) GetOfficialAccountInfo(appid string) (oa *OfficialAccount, err error) {
...
func (t *WxRelayServer) RefreshComponentVerifyTicket(cvt *ComponentVerifyTicket) (code string, err error) {
